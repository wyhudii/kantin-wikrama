                        ...
                        <form action="{{ route('barangs.update', $barang->id) }}" method="POST">
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <select name="nama_pemasok" id="nama_pemasok" class="form-select">
                                        @foreach ($pemasok as $d)
                                            <option value="{{ $d->nama_pemasok }}" @if($d->nama_pemasok == $barang->nama_pemasok) selected @endif>{{ $d->nama_pemasok }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
